...
```{r gap1, fig.height = 0.75, echo = FALSE}
put_gap()
```
...
```{r gap2, fig.height = 0.25, fig.width = 7, echo = FALSE}
put_gap(col = "black", fill = "gray")
```
